...
convert_area_sqft_to_m2(df_cleaned)
...
df_cleaned_own_featured.to_csv('MachineLearning/tp1/data/processed/normalized_own_featured_train_casas_dev.csv', index=False)
